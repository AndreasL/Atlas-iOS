...
- (void)layoutSubviews
{
    ...
    rightButtonFrame.origin.y = 8.0f; // frame.size.height - rightButtonFrame.size.height - self.buttonCenterY - self.sendButtonOffset;
    ...
    self.statusLabel.frame = CGRectMake(ATLLeftButtonHorizontalMargin + 5.0f, 8.0f + self.textInputView.frame.origin.y + self.textInputView.frame.size.height, 202.0f, 22.0f);
    
    CGRect statusLabelFrame = self.statusLabel.frame;
    statusLabelFrame.origin.x = CGRectGetWidth(frame) - CGRectGetWidth(statusLabelFrame) - 15.0f;
    self.statusLabel.frame = statusLabelFrame;
    // [self.statusLabel sizeToFit];
    
    self.actionButton.frame = CGRectMake(15.0f, 5.0f + self.textInputView.frame.origin.y + self.textInputView.frame.size.height, 202.0f, 22.0f);
